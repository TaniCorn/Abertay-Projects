...
public:
	...
	float* results;
	int resolution;
	void SetConstants(ID3D11DeviceContext* context, XMFLOAT3 faultLine)
	{
		Faulting fa; fa.faultLine = faultLine;
		context->UpdateSubresource(cb_FaultLines, 0, nullptr, &fa, 0, 0);
		context->CSSetConstantBuffers(1, 1, &cb_FaultLines);
	}
	bool fin = false;
private:
...
protected:
	...
	ID3D11Buffer* cb_FaultLines = nullptr;
